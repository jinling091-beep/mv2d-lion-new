...
class TransFusionHead(nn.Module):
    ...
    def get_targets_single(self, gt_bboxes_3d, gt_labels_3d, preds_dict):
        ...
        #check box convert error

        # print(
        #     "[LION target] gt shape:",
        #     tuple(gt_bboxes_3d.shape)
        # )

        # if gt_bboxes_3d.numel() > 0:
        #     print(
        #         "[LION target] xyz:",
        #         gt_bboxes_3d[:, 0:3].detach().cpu()
        #     )
        #     print(
        #         "[LION target] dimensions:",
        #         gt_bboxes_3d[:, 3:6].detach().cpu()
        #     )
        #     print(
        #         "[LION target] labels:",

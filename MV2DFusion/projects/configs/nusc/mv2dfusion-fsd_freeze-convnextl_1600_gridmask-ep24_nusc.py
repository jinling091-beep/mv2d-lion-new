...
num_gpus = 2
batch_size = 1
num_iters_per_epoch = 34149 // (num_gpus * batch_size) #train 28130 trainval 34149
num_epochs = 3
queue_length = 1
num_frame_losses = 1

pts_ckpt = 'weights/fsdv2_special_63_68_channel_converted.pth'
...
data_root = '/media/shs/0b404475-9f2a-462b-9440-2e145666c221/wy_code_space/data/nuscenes/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes2d_temporal_infos_trainval.pkl',
    ...
    val=dict(
        ...
        queue_length=queue_length,
        ann_file=data_root + 'nuscenes2d_temporal_infos_test_new.pkl',
        classes=class_names,
        modality=input_modality),
    test=dict(
        type=dataset_type,
...
# load_from = '/media/shs/0b404475-9f2a-462b-9440-2e145666c221/wy_code_space/MV2DFusion/weights/mv2d_Special_Dataset_6911_7106_with_fsdv2_Special_63_68.pth'
# load_from = '/media/shs/0b404475-9f2a-462b-9440-2e145666c221/wy_code_space/MV2DFusion/work_dirs/mv2dfuison-lion_freeze-convnextl_1600_gridmask-ep24_nusc/iter_126585.pth'
load_from = '/media/shs/0b404475-9f2a-462b-9440-2e145666c221/wy_code_space/MV2DFusion/work_dirs/mv2dfuison-lion_freeze-convnextl_1600_gridmask-ep24_nusc/epoch_3.pth'
# load_from = None
# resume_from = '/media/shs/0b404475-9f2a-462b-9440-2e145666c221/wy_code_space/MV2DFusion/work_dirs/mv2dfuison-lion_freeze-convnextl_1600_gridmask-ep24_nusc/iter_17074.pth'
# resume_from = '/media/shs/0b404475-9f2a-462b-9440-2e145666c221/wy_code_space/MV2DFusion/work_dirs/mv2dfuison-lion_freeze-convnextl_1600_gridmask-ep24_nusc/iter_30000.pth'

...
data_root = '/home/shs/wy_DF_data/L3/to_huake/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'mv2dfusion_temporal_infos_train.pkl',
    ...
    test=dict(
        ...
        collect_keys=collect_keys + ['img', 'img_metas'],
        queue_length=queue_length,
        ann_file=data_root + 'total_top_center_final.pkl',
        classes=class_names,
        modality=input_modality),
...
checkpoint_config = dict(interval=1 * 2000)
